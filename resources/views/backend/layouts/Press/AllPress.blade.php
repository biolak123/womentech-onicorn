                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      ?>
                        ...
                        <tr>
                        <!-- <td>{{ $loop->index + 1 }}</td> -->
                          <td><img src="public/backend/images/press/{{$press->image}}" height="100" width="100" alt=""></td>
                       
                          <td>{{$press->content}}</td>
                          <td>{{$press->create_at}}</td>
                         
                          <td >
                          <div class="fa-hover col-md-3 col-sm-4  "><a href="{{URL::to('/press/edit/'.$key.$press->id)}}"><i class="fa fa-wrench"></i></a>
                            
                              <div class="fa-hover col-md-3 col-sm-4  "><a onclick="return comfirm('Bạn có chắc muốn xóa sản phẩm này không?')" href="{{URL::to('/press/delete/'.$key.$press->id)}}"><i class="fa fa-trash"></i></a>
                        </div>
