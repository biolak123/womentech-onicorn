...
<head>
    ...
    <link rel="stylesheet" href="{{('public/frontend/css/huongdan.css')}}">
...
<script src="{{('public/frontend/js/dichvu.js')}}"></script>
<script src="{{('public/frontend/js/privacy.js')}}"></script>
