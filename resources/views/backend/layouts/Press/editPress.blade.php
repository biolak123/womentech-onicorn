...
<head>
    ...
    <title>Sửa Báo chí | Pos Coron! </title>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="" action="{{URL::to('/press/update/'.$press->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <img src="https://womentech.finance/public/backend/images/press/{{$press->image}}" height="100" width="100" alt="">
                                </div>
                            </div>
