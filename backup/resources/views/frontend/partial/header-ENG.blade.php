<header>
        <div id="Sidenav" class="sidenav" style="width: 0px;">
            ...
            <div class="items">
                <a href="{{url('/about-user')}}">About Us</a>
                <a href="{{url('/token-user')}}">Token</a>
            </div>
            <a id="menu3" href="{{url('/service-user')}}" data-i18n="language.menu.link3">Service</a>
            <a id="menu4" href="{{url('/news-user')}}" data-i18n="language.menu.link4">News</a>
            <a id="menu5" href="{{url('/help')}}" data-i18n="language.menu.link5">Help</a>
            <a id="menu6" href="{{url('/contact-user')}}" data-i18n="language.menu.link6">Contact</a>
            <div class="icon-menu">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            <!-- logo -->
            <div class="container">
                <a class="navbar-brand" href="{{url('/home-user')}}"><img src="{{url('public/frontend/images/Logo.png')}}" alt=""></a>
                <!-- login button mobile -->
                <div class="menu-mb">
                    <img onclick="window.location.href = '{{url('/home-userVn')}}'" class="img-mb" src="{{url('public/frontend/svg/laco.svg')}}" alt="">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <!-- <a class="nav-link" href="public/frontend/LoTrinhEn.html">Token</a> -->
                        </li>
                        ...
                        <!-- <li class="nav-item login">
                            <img src="public/frontend/svg/laco.svg" onclick="window.location.href = 'DichVu.html'" alt="">
                        </li> -->
                        <li class="nav-item login dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{url('public/frontend/images/united-states.png')}}" alt=""></a>
                            <div class="dropdown-menu dropdown-flag" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item flag" href="{{url('/home-userVn')}}"><img src="{{url('public/frontend/images/laco.png')}}" alt=""></a>
                                <a class="dropdown-item flag" href="{{url('/home-user')}}"><img src="{{url('public/frontend/images/united-states.png')}}" alt=""></a>
                                </a>
                            </div>
                        </li>
                    </ul>
