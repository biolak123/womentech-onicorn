...
<body class="nav-md">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="fa-hover col-md-3 col-sm-4  "><a
                                                                href="{{URL::to('/partner/edit/'.$key.$partner->id)}}"><i
                                                                    class="fa fa-wrench"></i></a>

                                                            <div class="fa-hover col-md-3 col-sm-4  "><a
                                                                    onclick="setValueDelete(<?php echo $key . $partner->id; ?>)"><i
    ...
    function setValueDelete(id) {
        ...
        if (r == true) {
            window.location = "{{asset('')}}partner/delete/" + id
        } else {
            window.location = "{{asset('')}}partner/"
        }
