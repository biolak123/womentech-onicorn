...
<head>
    ...
    <title>Sửa Đối tác | Pos Coron! </title>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="" action="{{URL::to('/partner/update/'.$partner->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
