    ...
    <div class="container">
        <div class="top-main">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="content">
                        <p>WomenTech Singapore ra đời là Quỹ khởi nghiệp sáng tạo với sứ mệnh hỗ trợ, kiến tạo đồng hành
                            cùng phụ nữ khởi nghiệp và các nữ doanh chủ trong kỷ nguyên số. <br><br>WomenTech với tầm
                            nhìn trở thành đầu tàu dẫn dắt và đồng
                            hành cùng những doanh nghiệp, những nữ doanh chủ khát vọng, đổi mới, sáng tạo. <br><br>Sau
                            nhiều năm tạo tiền đề và xây dựng nền tảng hệ sinh thái, WomenTech đã chính thức phát hành
                            WTA Token dựa trên nền tảng công nghệ
                            Blockchain dành cho các cá nhân, doanh chủ và doanh nghiệp cho việc phát triển, quản lý
                            chuỗi cung ứng qua các hợp đồng thông minh. Đồng thời WTA Token là tài sản số chính thức của
                            Quỹ khởi nghiệp sáng tạo dành cho phụ
                            nữ toàn cầu, được phát triển bởi đội ngũ chuyên gia và cố vấn tại nhiều nơi trên thế giới.
                            <br><br>WTA với lộ trình được đề ra trong vòng 5 năm tới, sẽ hỗ trợ hàng triệu người trên
                            thế giới và hàng ngàn doanh nghiệp khởi
                            nghiệp sáng tạo, xây dựng nền tảng và hệ sinh thái doanh nghiệp bền vững.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="wta">
            ...
            <div class="row">
                <div class="wta-bottom">
                    <p>Và hơn hết, WTA được sử dụng trong hệ sinh thái WomenTech để trao đổi các dịch vụ đời sống như:
                        Thương mại điện tử, nền tảng học trực tuyến, các nhà hàng, khách sạn, bất động sản, và ứng dụng
                        trong hệ sinh thái.<br><br> Với mục
                        tiêu và sứ mệnh hướng đến cộng đồng, đặc biệt là phụ nữ trong thời đại số, WTA chính là tài sản
                        đầu tư gắn liền với sự phát triển lớn mạnh của hệ sinh thái qua tính ứng dụng thực tế vào cuộc
                        sống và các giá trị nhân văn.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                        ...
                        <div class="box">
                            ...
                            <div class="box-name">
                                ...
                                <ul id="infor">
                                    ...
                                    <li>Set up vận hành các hệ thống trường liên cấp Hoàng Diệu Victoria tại Hà Nội,
                                        Bình Dương và Pleiku</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="box">
                            ...
                            <div class="box-name">
                                ...
                                <p id="position">CEO </p>
                                <ul id="infor">
                                    <li>Chủ tịch kiêm Viện trưởng Viện Nghiên Cứu Tài Chính, Đầu tư và Hợp tác Thương
                                        mại Đông Nam Á</li>
                    ...
                    <div class="carousel-item">
                        <div class="box">
                            <div class="layer"></div>
                            <img src="{{url('public/frontend/images/01 31.jpg')}}" alt="">
                            <div class="box-name">
                                <p id="name">Bà. Nguyễn Thị Minh Hà</p>
                                <p id="position">CFO</p>
                                <ul id="infor">
                                    <li>Cử nhân tiếng Pháp - ĐHQG Hà Nội .</li>
                                    <li>Cử nhân tài chính - ĐHKTQD HN.</li>
                                    <li>Đồng sáng lập Lượng LAB - Dental LAB. </li>
                                    <li>Chủ quán cafe Thiên Trường Nam Định.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box">
                            ...
                            <div class="box-name">
                                ...
                                <ul id="infor">
                                    ...
                                    <li>Thành viên của JCI Vietnam Thành viên của liên đoàn lãnh đạo trẻ và doanh nhân
                                        thế giới</li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="box">
                        ...
                        <div class="box-name">
                            ...
                            <ul id="infor">
                                ...
                                <li>Nhà đầu tư giáo dục, nhà quản lý trường học</li>
                                <li>Nhà giáo, Nhà nghiên cứu giáo dục thời 4.0</li>
                                <li>Set up vận hành các hệ thống trường liên cấp Hoàng Diệu Victoria tại Hà Nội, Bình
                                    Dương và Pleiku</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="box">
                        ...
                        <div class="box-name">
                            ...
                            <p id="position">CEO </p>
                            <ul id="infor">
                                <li>Chủ tịch kiêm Viện trưởng Viện Nghiên Cứu Tài Chính, Đầu tư và Hợp tác Thương mại
                                    Đông Nam Á</li>
                                <li>Tác giả và chủ nhiệm dự án Edutech - Trường học trực tuyến số 1 Việt Nam</li>
                            </ul>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="box">
                        ...
                        <div class="box-name">
                            ...
                            <ul id="infor">
                                <li>Founder & CEO Công ty cổ phần truyền thông Onicorn</li>
                                <li>Thành viên của JCI Vietnam Thành viên của liên đoàn lãnh đạo trẻ và doanh nhân thế
                                    giới</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item">
                        <div class="box">
                            ...
                            <div class="box-name">
                                ...
                                <ul id="infor">
                                    <li>Nguyên Phó chủ nhiệm Ủy ban Quốc phòng – An ninh Quốc hội nước CHXHCN Việt Nam
                                    </li>
