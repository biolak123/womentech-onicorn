...
<head>
    ...
    <title>WE WOULD | Pos Coron! </title>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        @foreach($we_would as $press)
                        
                        <form class="" action="{{URL::to('/we-would/update/'.$press->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <meta name="csrf-token" content="{{ csrf_token() }}">
                            <p>For alternative validation library <code>parsleyJS</code> check out in the <a href="form.html">form page</a>
                            </p>
                            <span class="section">Thông tin WE WOULD</span>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" value="{{$press->content}}" name="content" placeholder=" ...." required="required" />
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <img src="https://womentech.finance/public/backend/images/we-would/{{$press->image}}" height="100" width="100" alt="">
                                </div>
                            </div>
