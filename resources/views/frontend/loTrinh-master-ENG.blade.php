...
<head>
    ...
    <script src="{{('public/frontend/js/charts.js')}}"></script>
    <script src="{{('public/frontend/js/animated.js')}}"></script>
    <link rel="stylesheet" href="{{('public/frontend/css/lotrinh.css')}}">
...
<script src="{{('public/frontend/js/lotrinh.js')}}"></script>
