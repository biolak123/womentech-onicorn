            ...
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="" action="{{URL::to('/admins/update/'.$admin->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" value="{{$admin->name}}" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="Giày ...." required="required" />
                                </div>
                            </div>
                            <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Email<span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" value="{{$admin->email}}" class='price' name="email" type="email"  readonly/>
                                    </div>
                                </div>
                                <div class="field item form-group">
