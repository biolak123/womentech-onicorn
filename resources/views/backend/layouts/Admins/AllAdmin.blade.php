    ...
    <div class="">
      <div class="page-title">
        <div class="title_left">
          <h3>Quản lí Admin <small> </small></h3>
        </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="fa-hover col-md-3 col-sm-4  "><a href="{{URL::to('/admins/edit/'.$key.$admin->id)}}"><i class="fa fa-wrench"></i></a>

                              <div class="fa-hover col-md-3 col-sm-4  "><a onclick="return comfirm('Bạn có chắc muốn xóa sản phẩm này không?')" href="{{URL::to('/admins/delete/'.$key.$admin->id)}}"><i class="fa fa-trash"></i></a>
                              </div>
