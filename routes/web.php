...
Route::group(['module' => 'dashboard', 'middleware' => 'web', 'namespace' => "App\Http\Controllers"], function () {
    Route::get("/", ["as" => "admin.dashboard.index", "uses" => "NewsFrontendController@getIndexHomeENG"]);
...
Route::group(['module' => 'dashboard', 'middleware' => 'web', 'namespace' => "App\Http\Controllers"], function () {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::group(["prefix" => "banner-home"], function () {
            Route::get("/edit/{id}", ["as" => "admin.about-us.edit", "uses" => "AboutUsDashbordController@getUpdateBanner"]);
            
        
            Route::post("update/{id}", ["as" => "admin.about-us.update", "uses" => "AboutUsDashbordController@postUpdateBanner"]);
        });
        //partner
        Route::group(["prefix" => "partner"], function () {
            Route::get("/", ["as" => "admin.partner", "uses" => "PartnerDashboardController@getPartner"]);
            Route::get("add", ["as" => "admin.partner.add", "uses" => "PartnerDashboardController@getAddPartner"]);
            Route::post("save", ["as" => "admin.partner.add", "uses" => "PartnerDashboardController@getSavePartner"]);
            Route::get("delete/{id}", ["as" => "admin.partner.delete", "uses" => "PartnerDashboardController@deletePartner"]);
            Route::get("edit/{id}", ["as" => "admin.partner.edit", "uses" => "PartnerDashboardController@getEditPartner"]);
            Route::post("update/{id}", ["as" => "admin.partner.eidt", "uses" => "PartnerDashboardController@getUpdatePartner"]);
        });
    });
});
...
Route::group(['module' => 'user', 'middleware' => 'web', 'namespace' => "App\Http\Controllers"], function () {
    ...
    Route::get("/home-userVn", ["as" => "admin.user.index.home", "uses" => "NewsFrontendController@getIndexHomeVn"]);
    Route::get("/about-userVn", ["as" => "admin.user.index.about", "uses" => "NewsFrontendController@getIndexAboutVn"]);
    Route::get("/service-userVn", ["as" => "admin.user.index.service", "uses" => "NewsFrontendController@getIndexServiceVn"]);
    Route::get("/docthem-userVn", ["as" => "admin.user.index.docthem", "uses" => "NewsFrontendController@getIndexDocthemVn"]);
    Route::get("/contact-userVn", ["as" => "admin.user.index.contact", "uses" => "NewsFrontendController@getIndexContactVn"]);
    Route::get("/token-userVn", ["as" => "admin.user.index.token", "uses" => "NewsFrontendController@getIndexTokenVn"]);
