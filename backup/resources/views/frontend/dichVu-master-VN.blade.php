...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/frontend/css/dichvu.css')}}">
    <link rel="stylesheet" href="{{asset('public/frontend/css/lgVN.css')}}">
...
<script src="{{asset('public/frontend/js/dichvu.js')}}"></script>
